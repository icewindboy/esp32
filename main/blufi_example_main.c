...
static void onLongPressed(lv_event_t *event)
{
    BLUFI_INFO("long long pressed!");
}
...
void create_demo(void)
{
    ...
    lv_obj_add_event_cb(panel, onLongPressed, LV_EVENT_LONG_PRESSED_REPEAT, NULL);

    BLUFI_INFO("MSG1:CREATED_DEMO");
}
