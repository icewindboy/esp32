...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_height(ui_Header, 26);
    ...
    lv_obj_set_width(ui_Arc1, 144);
    lv_obj_set_height(ui_Arc1, 144);
    ...
    lv_obj_set_width(ui_Temp_Bg, 95);
    lv_obj_set_height(ui_Temp_Bg, 95);
    lv_obj_set_x(ui_Temp_Bg, -21);
    lv_obj_set_y(ui_Temp_Bg, 1);
    ...
    lv_obj_set_width(ui_Temp_Num_Bg, 95);
    lv_obj_set_height(ui_Temp_Num_Bg, 95);
    ...
    lv_obj_set_style_text_font(ui_Label_Celsius, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Label_Slider = lv_label_create(ui_Screen1);
    lv_obj_set_width(ui_Label_Slider, 15);
    lv_obj_set_height(ui_Label_Slider, 137);
    lv_obj_set_x(ui_Label_Slider, 133);
    lv_obj_set_y(ui_Label_Slider, -48);
    ...
    if(lv_slider_get_mode(ui_Fan_Speed_Control) == LV_SLIDER_MODE_RANGE) lv_slider_set_left_value(ui_Fan_Speed_Control, 0,
                                                                                                      LV_ANIM_OFF);
    lv_obj_set_width(ui_Fan_Speed_Control, 15);
    lv_obj_set_height(ui_Fan_Speed_Control, 128);
    lv_obj_set_x(ui_Fan_Speed_Control, -52);
    lv_obj_set_y(ui_Fan_Speed_Control, 5);
    lv_obj_set_align(ui_Fan_Speed_Control, LV_ALIGN_RIGHT_MID);
