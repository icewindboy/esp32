...
{ // The computation is explained here: https://www.maximintegrated.com/en/design/technical-documents/app-notes/5/5296.html
    const lv_tc_val_t divisor = ((lv_tc_val_t)tchP[0].x * ((lv_tc_val_t)tchP[2].y - (lv_tc_val_t)tchP[1].y) - (lv_tc_val_t)tchP[1].x * (lv_tc_val_t)tchP[2].y + (lv_tc_val_t)tchP[1].y * (lv_tc_val_t)tchP[2].x + (lv_tc_val_t)tchP[0].y * ((lv_tc_val_t)tchP[1].x - (lv_tc_val_t)tchP[2].x));

    lv_tc_coeff_t result = {
        true,
        (
            (lv_tc_val_t)scrP[0].x * ((lv_tc_val_t)tchP[2].y - (lv_tc_val_t)tchP[1].y) - (lv_tc_val_t)scrP[1].x * (lv_tc_val_t)tchP[2].y + (lv_tc_val_t)scrP[2].x * (lv_tc_val_t)tchP[1].y + ((lv_tc_val_t)scrP[1].x - (lv_tc_val_t)scrP[2].x) * (lv_tc_val_t)tchP[0].y) /
            divisor,
        -(
            (lv_tc_val_t)scrP[0].x * ((lv_tc_val_t)tchP[2].x - (lv_tc_val_t)tchP[1].x) - (lv_tc_val_t)scrP[1].x * (lv_tc_val_t)tchP[2].x + (lv_tc_val_t)scrP[2].x * (lv_tc_val_t)tchP[1].x + ((lv_tc_val_t)scrP[1].x - (lv_tc_val_t)scrP[2].x) * (lv_tc_val_t)tchP[0].x) /
            divisor,
        (
            (lv_tc_val_t)scrP[0].x * ((lv_tc_val_t)tchP[1].y * (lv_tc_val_t)tchP[2].x - (lv_tc_val_t)tchP[1].x * (lv_tc_val_t)tchP[2].y) + (lv_tc_val_t)tchP[0].x * ((lv_tc_val_t)scrP[1].x * (lv_tc_val_t)tchP[2].y - (lv_tc_val_t)scrP[2].x * (lv_tc_val_t)tchP[1].y) + (lv_tc_val_t)tchP[0].y * ((lv_tc_val_t)scrP[2].x * (lv_tc_val_t)tchP[1].x - (lv_tc_val_t)scrP[1].x * (lv_tc_val_t)tchP[2].x)) /
            divisor,
        (
            (lv_tc_val_t)scrP[0].y * ((lv_tc_val_t)tchP[2].y - (lv_tc_val_t)tchP[1].y) - (lv_tc_val_t)scrP[1].y * (lv_tc_val_t)tchP[2].y + (lv_tc_val_t)scrP[2].y * (lv_tc_val_t)tchP[1].y + ((lv_tc_val_t)scrP[1].y - (lv_tc_val_t)scrP[2].y) * (lv_tc_val_t)tchP[0].y) /
            divisor,
        -(
            (lv_tc_val_t)scrP[0].y * ((lv_tc_val_t)tchP[2].x - (lv_tc_val_t)tchP[1].x) - (lv_tc_val_t)scrP[1].y * (lv_tc_val_t)tchP[2].x + (lv_tc_val_t)scrP[2].y * (lv_tc_val_t)tchP[1].x + ((lv_tc_val_t)scrP[1].y - (lv_tc_val_t)scrP[2].y) * (lv_tc_val_t)tchP[0].x) /
            divisor,
        (
            (lv_tc_val_t)scrP[0].y * ((lv_tc_val_t)tchP[1].y * (lv_tc_val_t)tchP[2].x - (lv_tc_val_t)tchP[1].x * (lv_tc_val_t)tchP[2].y) + (lv_tc_val_t)tchP[0].x * ((lv_tc_val_t)scrP[1].y * (lv_tc_val_t)tchP[2].y - (lv_tc_val_t)scrP[2].y * (lv_tc_val_t)tchP[1].y) + (lv_tc_val_t)tchP[0].y * ((lv_tc_val_t)scrP[2].y * (lv_tc_val_t)tchP[1].x - (lv_tc_val_t)scrP[1].y * (lv_tc_val_t)tchP[2].x)) /
            divisor};
...
lv_point_t lv_tc_transform_point(lv_point_t point)
{
    ...
    if (calibResult.isValid)
    {
        ...
        tranformedPoint.x = tranformedPoint.x < 0 ? 0 : tranformedPoint.x;
        tranformedPoint.y = tranformedPoint.y < 0 ? 0 : tranformedPoint.y;
    }
